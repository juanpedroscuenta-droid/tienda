...
export const LoginPage: React.FC = () => {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // TODO: Implementar recuperación de contraseña en NestJs
    toast({ title: "Próximamente", description: "Recuperación de contraseña en mantenimiento" });
    setIsLoading(false);
  };
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-center text-[12px] text-gray-400">
                  ¿No tienes cuenta? <button onClick={() => navigate('/register')} className="text-black font-bold hover:underline">Regístrate aquí</button>
                </p>
              </div>
            </div>
          )}
          ...
          {view === 'form' && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div>
                ...
                <p className="text-[13px] text-gray-500 font-medium">Ingresa los datos de tu cuenta</p>
              </div>
