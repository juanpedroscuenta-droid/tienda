...
export const HeroBanner: React.FC<HeroBannerProps> = ({ isCatalog }) => {
  return (
    <section className="w-full bg-white pt-0 pb-0 flex justify-center">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-0 sm:px-4 md:px-6 lg:px-8">
        ...
        {isCatalog && (
          <div className="w-full text-center py-4 bg-gray-50 border-b border-x border-gray-200 rounded-b-xl shadow-sm mb-4">
