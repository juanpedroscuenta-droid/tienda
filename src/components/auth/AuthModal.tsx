        ...
        {showForgotPassword ? (
          ...
          <>
            ...
            <div className="p-4 sm:p-6 pt-0 text-center">
              ...
              <h3 className="text-lg font-medium mb-2">¡Bienvenido a nuestra tienda!</h3>
                      ...
                      <form onSubmit={handleLogin} className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center justify-between">
                            ...
                            <Button 
                              type="button"
                              variant="link" 
                              className="p-0 text-orange-500 h-auto text-xs"
                        ...
                        <div className="flex flex-col gap-2 pt-2">
                          <button
                            ...
                            disabled={isLoading}
                            className="w-full group flex items-center justify-center gap-3 px-4 py-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98] disabled:opacity-50"
                          >
                            ...
                            <span className="text-[12px] font-bold text-gray-700">Google</span>
                          </button>
                          ...
                          <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase font-bold text-gray-300">
                              <span className="bg-white px-2">O CONTINUA CON EMAIL</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <CardContent className="px-0 pt-0">
                      <form onSubmit={handleRegister} className="space-y-3">
                        ...
                        <div className="flex gap-3 justify-between pt-2">
                          ...
                          <Button 
                            type="submit" 
                            className={`gradient-orange hover:opacity-90 transition-opacity ${registerStep === 'personal' ? 'flex-1' : 'flex-1'}`}
                            disabled={isLoading}
                          >
                            {isLoading ? (
