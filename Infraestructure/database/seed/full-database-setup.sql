...
-- Tabla de configuración de chatbot
...
-- Tabla de correos recibidos (Inbound)
...
-- Chatbot Settings
DROP POLICY IF EXISTS "chatbot_read" ON public.chatbot_settings;
DROP POLICY IF EXISTS "chatbot_insert" ON public.chatbot_settings;
DROP POLICY IF EXISTS "chatbot_update" ON public.chatbot_settings;
